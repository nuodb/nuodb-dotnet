...
");
    ...
    ""Event"" TEXT NOT NULL DEFAULT '2015-04-12 17:05:00.000'
);
");
        }
        ...
        public override void DefaultValue_with_line_breaks(bool isUnicode)
        {
            ...
            var expectedSql = @$"CREATE TABLE IF NOT EXISTS ""TestLineBreaks"" (
...
";
        ...
        public override void DefaultValue_with_line_breaks_2(bool isUnicode)
        {
            ...
            AssertSql(
                @"CREATE TABLE IF NOT EXISTS ""TestLineBreaks"" (
...
");
        ...
        public void CreateTableOperation_with_annotations(bool autoincrement, string pkName)
        {
            ...
            AssertSql(
                $@"CREATE TABLE ""People"" (
    ""Id"" INTEGER NOT NULL{(pkName != null ? $@" CONSTRAINT ""{pkName}""" : "")} PRIMARY KEY{(autoincrement ? " GENERATED BY DEFAULT AS IDENTITY," : ",")}
    ""EmployerId"" int NULL,
    ""SSN"" char(11) NULL,
    UNIQUE (""SSN""),
...
");
        ...
        public override void AddColumnOperation_with_maxLength_overridden()
        {
            ...
            AssertSql(
                @"ALTER TABLE ""Person"" ADD ""Name"" NATIONAL CHAR VARYING(32) NULL;
");
        }
...
");
        ...
        public override void AddColumnOperation_with_maxLength_no_model()
        {
            ...
            AssertSql(
                @"ALTER TABLE ""Person"" ADD ""Name"" NATIONAL CHAR VARYING(30) NULL;
");
        }
