...
namespace NuoDb.EntityFrameworkCore.NuoDb.Query.Internal
{
    ...
    /// </summary>
    public class NuoDbGlobMethodTranslator : IMethodCallTranslator
    {
        private static readonly MethodInfo _methodInfo = typeof(NuoDbDbFunctionsExtensions)
            .GetRequiredMethod(nameof(NuoDbDbFunctionsExtensions.Glob), typeof(DbFunctions), typeof(string), typeof(string));
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public NuoDbGlobMethodTranslator(ISqlExpressionFactory sqlExpressionFactory)
