...
{
    /// <summary>
    ///     Contains extension methods on <see cref="DbFunctions" /> for the NuoDb.EntityFrameworkCore.NuoDb provider.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        ///     Maps to the NuoDb <c>glob</c> function which is similar to
        ...
        /// <summary>
        ///     Maps to the NuoDb <c>hex</c> function which returns a hexadecimal string representing the specified value.
        /// </summary>
        /// <remarks>
        ///     See <see href="https://aka.ms/efcore-docs-database-functions">Database functions</see>, and
        /// </remarks>
        ...
        /// <summary>
        ///     Maps to the NuoDb <c>substr</c> function which returns a subarray of the specified value. The subarray starts
        ...
        /// <summary>
        ///     Maps to the NuoDb substr function which returns a subarray of the specified value. The subarray starts
